...
namespace Sphinx.Client.Resources {
    ...
    internal class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to RankingExpression can not be null or empty, if MatchRankMode.Expression is selected.
        /// </summary>
        internal static string Exception_ArgumentRankingExpressionIsEmpty {
            get {
                return ResourceManager.GetString("Exception_ArgumentRankingExpressionIsEmpty", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to SortBy property can not be empty if sorting mode &apos;{0}&apos; is selected.
        /// </summary>
